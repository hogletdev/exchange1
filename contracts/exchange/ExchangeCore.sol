...
contract ExchangeCore is ReentrancyGuarded, Ownable {
    ...
    struct Sig {
        ...
        /* r parameter */
        bytes32 r;
        // 0x1285984dfe07d5275137dcef5f28ff892bcda896ea45d906990bdcfc794e38a8
        // 0x1285984dfe07d5275137dcef5f28ff892bcda896ea45d906990bdcfc794e38a8
        /* s parameter */
        bytes32 s;
        // 0x1ff3929874370a99f41ea4fd7a1f86f04bd1afb5cfb258eee562873b630366b6
        // 0x1ff3929874370a99f41ea4fd7a1f86f04bd1afb5cfb258eee562873b630366b6
    }
    ...
    struct Order {
        ...
        /* Order maker address. */
        address maker;
        // 0xE2AD56A35bBbbb8de1ee8ff932F1b1B58195Fb49
        // 0x7D9cF163Fda126a69b491ad581C96C3B5E1652af
        ...
        /* Calldata. */
        bytes calldata;
        // 
        // 
        ...
        uint salt;
        // 57161366330012653759253060326559585399068629634188700698159735887835963062813
        // 63072316364136279444442622442122191223383061766682082050210913401165021752262
    }
        ...
        returns (uint)
    {
        ...
        if (sell.feeRecipient != address(0)) {
            ...
            if (sell.feeMethod == FeeMethod.SplitFee) {
                ...
                // TODO: check if the following is correct absolutely
        ...
        reentrancyGuard
    {
        ...
        // TODO: check here => Remix JavaVM return false, while obviously, their length equals
        ...
        // TODO: check here invoke sth related with MerkleRoot
